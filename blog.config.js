...
const BLOG = {
  ...
  NOTION_PAGE_ID: 'f41e90f58fc1448aba77cebd844b088d',
  ...
  AUTHOR: '林北路', // 您的昵称 例如 tangly1024
  BIO:  '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://github.com/linbeilu', // 网站地址
  KEYWORDS: '林北路, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL:  '', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO:  '', // 你的微博个人主页
  CONTACT_TWITTER:  '', // 你的twitter个人主页
  CONTACT_GITHUB:  'https://github.com/linbeilu', // 你的github个人主页 例如 https://github.com/tangly1024
